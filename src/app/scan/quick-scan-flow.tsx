      ...
      <section className="scan-workspace">
        ...
        {step === "review" && extraction && resolvedType && (
          <section className="scan-review">
            ...
            <label className="scan-field">Expiry date<input type="date" value={review.expiryDate ?? ""} onInput={(event) => { const expiryDate = event.currentTarget.value; setReview((value) => ({ ...value, expiryDate })); }} onChange={(event) => setReview((value) => ({ ...value, expiryDate: event.target.value }))} /></label>
            <label className="scan-field">Issue date<input type="date" value={review.issueDate ?? ""} onInput={(event) => { const issueDate = event.currentTarget.value; setReview((value) => ({ ...value, issueDate })); }} onChange={(event) => setReview((value) => ({ ...value, issueDate: event.target.value }))} /></label>
            ...
            <label className="scan-field">Date of birth<input type="date" value={review.dateOfBirth ?? ""} onInput={(event) => { const dateOfBirth = event.currentTarget.value; setReview((value) => ({ ...value, dateOfBirth })); }} onChange={(event) => setReview((value) => ({ ...value, dateOfBirth: event.target.value }))} /></label>

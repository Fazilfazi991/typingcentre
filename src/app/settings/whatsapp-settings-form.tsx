...
export function WhatsAppSettingsForm({
  ...
  return <>
    <form action={action} className="whatsapp-settings-form">
      ...
      <button className="primary-button" type="submit" disabled={pending} aria-disabled={pending} style={{ justifySelf: "start", padding: "10px 16px", fontSize: "0.95rem" }}>{pending ? "Saving…" : "Save WhatsApp settings"}</button>
    </form>

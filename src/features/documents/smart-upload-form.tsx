...
export function SmartUploadForm({ customerId, companyId, customerName, companyName, documentTypes }: Props) {
  ...
  if (stage === "saved") return <section className="panel smart-upload success"><h2>Document saved</h2><p>The reviewed document details are now available to RenewTrack’s expiry tracking.</p></section>;

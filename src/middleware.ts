...
export const config = {
  matcher: [
    "/((?!$|_next/static|_next/image|favicon.ico|robots.txt|sitemap.xml|login|signup|forgot-password|reset-password|auth/callback|auth/error|demo|privacy-policy|terms|data-deletion|api/webhooks|api/internal).*)",
  ],
};

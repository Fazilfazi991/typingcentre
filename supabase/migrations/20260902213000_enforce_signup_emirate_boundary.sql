-- Keep the public signup boundary aligned with Note It's canonical UAE
-- Emirate list. The browser is not trusted to enforce this constraint.
...
begin
  ...
  if normalized_location not in (
    ...
    'Ras Al Khaimah',
    'Fujairah'
  ) then raise exception 'Invalid workspace location'; end if;

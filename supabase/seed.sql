...
alter table public.documents disable trigger documents_set_creator;
...
set company_id = case id
  when '30000000-0000-4000-8000-000000000001'::uuid then '50000000-0000-4000-8000-000000000001'::uuid
  when '30000000-0000-4000-8000-000000000002'::uuid then '50000000-0000-4000-8000-000000000002'::uuid
  when '30000000-0000-4000-8000-000000000003'::uuid then '50000000-0000-4000-8000-000000000003'::uuid
end
where id in (
...
insert into public.documents (id, organization_id, document_type_id, customer_id, company_id, branch_id, display_name, document_number, issued_on, expires_on, status) values
  ('70000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000001', '40000000-0000-4000-8000-000000000001', '60000000-0000-4000-8000-000000000001', '50000000-0000-4000-8000-000000000001', '30000000-0000-4000-8000-000000000001', 'Residence Visa', 'AN-VISA-001', '2025-08-01', '2026-08-03', 'expired'),
  ('70000000-0000-4000-8000-000000000002', '10000000-0000-4000-8000-000000000001', '40000000-0000-4000-8000-000000000002', null, '50000000-0000-4000-8000-000000000001', '30000000-0000-4000-8000-000000000001', 'Trade Licence', 'AN-LIC-001', '2025-08-01', '2026-08-10', 'urgent'),
  ('70000000-0000-4000-8000-000000000003', '10000000-0000-4000-8000-000000000002', '40000000-0000-4000-8000-000000000003', '60000000-0000-4000-8000-000000000002', '50000000-0000-4000-8000-000000000002', '30000000-0000-4000-8000-000000000002', 'Residence Visa', 'SD-VISA-001', '2025-08-01', '2026-09-01', 'expiring_soon')
on conflict (id) do nothing;
...
insert into public.customers (id, organization_id, company_id, full_name, email, phone, nationality) values
  ('60000000-0000-4000-8000-000000000004','10000000-0000-4000-8000-000000000001','50000000-0000-4000-8000-000000000004','John Mathew','john.mathew@demo.renewtrack.invalid','+971 50 000 1004','Indian'),
  ('60000000-0000-4000-8000-000000000005','10000000-0000-4000-8000-000000000001','50000000-0000-4000-8000-000000000005','Fathima Noor','fathima.noor@demo.renewtrack.invalid','+971 50 000 1005','Indian'),
  ('60000000-0000-4000-8000-000000000006','10000000-0000-4000-8000-000000000001','50000000-0000-4000-8000-000000000006','Mohammed Sameer','mohammed.sameer@demo.renewtrack.invalid','+971 50 000 1006','Indian'),
  ('60000000-0000-4000-8000-000000000007','10000000-0000-4000-8000-000000000001','50000000-0000-4000-8000-000000000007','Sara Khan','sara.khan@demo.renewtrack.invalid','+971 50 000 1007','Pakistani'),
  ('60000000-0000-4000-8000-000000000008','10000000-0000-4000-8000-000000000001','50000000-0000-4000-8000-000000000008','Ravi Kumar','ravi.kumar@demo.renewtrack.invalid','+971 50 000 1008','Indian'),
  ('60000000-0000-4000-8000-000000000009','10000000-0000-4000-8000-000000000001','50000000-0000-4000-8000-000000000009','Aisha Rahman','aisha.rahman@demo.renewtrack.invalid','+971 50 000 1009','Emirati'),
  ('60000000-0000-4000-8000-000000000010','10000000-0000-4000-8000-000000000001','50000000-0000-4000-8000-000000000010','Sajid Bukhari','sajid.bukhari@demo.renewtrack.invalid','+971 50 000 1010','Pakistani'),
  ('60000000-0000-4000-8000-000000000011','10000000-0000-4000-8000-000000000001','50000000-0000-4000-8000-000000000004','Lina Sharif','lina.sharif@demo.renewtrack.invalid','+971 50 000 1011','Jordanian'),
  ('60000000-0000-4000-8000-000000000012','10000000-0000-4000-8000-000000000001','50000000-0000-4000-8000-000000000005','Rakesh Kumar','rakesh.kumar@demo.renewtrack.invalid','+971 50 000 1012','Indian'),
  ('60000000-0000-4000-8000-000000000013','10000000-0000-4000-8000-000000000001','50000000-0000-4000-8000-000000000006','Noor Al Zahra','noor.alzahra@demo.renewtrack.invalid','+971 50 000 1013','Emirati'),
  ('60000000-0000-4000-8000-000000000014','10000000-0000-4000-8000-000000000001','50000000-0000-4000-8000-000000000007','Omar Farooq','omar.farooq@demo.renewtrack.invalid','+971 50 000 1014','Pakistani'),
  ('60000000-0000-4000-8000-000000000015','10000000-0000-4000-8000-000000000001','50000000-0000-4000-8000-000000000008','Shilpa Nair','shilpa.nair@demo.renewtrack.invalid','+971 50 000 1015','Indian'),
  ('60000000-0000-4000-8000-000000000016','10000000-0000-4000-8000-000000000001','50000000-0000-4000-8000-000000000009','Khalid Jassim','khalid.jassim@demo.renewtrack.invalid','+971 50 000 1016','Emirati'),
  ('60000000-0000-4000-8000-000000000017','10000000-0000-4000-8000-000000000001','50000000-0000-4000-8000-000000000010','Maria Santos','maria.santos@demo.renewtrack.invalid','+971 50 000 1017','Filipino')
on conflict (id) do nothing;

insert into public.documents (id, organization_id, document_type_id, customer_id, company_id, branch_id, display_name, document_number, issued_on, expires_on, status)
select ('70000000-0000-4000-8000-' || lpad((n + 3)::text, 12, '0'))::uuid, '10000000-0000-4000-8000-000000000001',
  ...
  ('50000000-0000-4000-8000-' || lpad((((n - 1) % 7) + 4)::text, 12, '0'))::uuid, null,
  'Demo document ' || lpad(n::text, 3, '0'), 'DEMO-AN-DOC-' || lpad(n::text, 3, '0'), current_date - interval '1 year',
...
alter table public.documents enable trigger documents_set_creator;
